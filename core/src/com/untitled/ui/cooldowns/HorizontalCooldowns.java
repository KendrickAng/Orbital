 ...
 */
public class HorizontalCooldowns extends Cooldowns {
	 ...
	 */
	public HorizontalCooldowns(UIAlign align, float padding, Texture cooldown0, Texture cooldown1, Texture cooldown2, Texture cooldown3, Texture cooldown4, Texture cooldown5) {
	...
	protected void update(Vector2 position, CooldownAbility ability) {
		position.x += ability.getWidth() + padding;
	}
}
