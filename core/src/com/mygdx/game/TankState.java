...
public class TankState {
    ...
    protected static final long PRIMARY_PERSIST_TIME = 0; // skill lasting time in ms
    protected static final long SECONDARY_PERSIST_TIME = 0;
    ...
    public boolean isSecondaryPressed() { return this.tertiary_pressed; }
